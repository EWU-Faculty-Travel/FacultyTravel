...
class Deleteuser extends MY_Controller
{
	...
	// passes in the correct accordion value to the view
	public function taview()
	{ 
		$this->usersView('CSCD', 'Select User to Delete', 0, 2);
	}
	
	// passes in correct accordion value to the view
	public function dtcview()
	{	
		$this->usersView('CSCD', 'Select User to Delete', 0, 1);
	}
	
	// Loads the view presenting the users in a dept. for selection for deletion
	public function usersView($dept, $page = 'Select User to Delete', $success = 0, $accordion = 0)
	{
	...
	public function deleteUser()
	{
		...
		$this->usersView($dept, 'Select User to Delete', 1, $accordion);
	}
}